//DEFINICIONES PARA ALIMENTAR EL ROSCO CON EL QUE SE VA A JUGAR
var questions = [
    [
    ...
    [
        ...
        { letter: "g", answer: "gobernante", status: 0, question: "CON LA G. Que gobierna" },
    ...
    [
        ...
        { letter: "k", answer: "kosovar", status: 0, question: "CON LA K. Natural de Kosovo, provincia autónoma de Serbia" },
    ...
    [
        ...
        { letter: "w", answer: "wolframio", status: 0, question: "CONTIENE LA W. También conocido como tungsteno,​ es un elemento químico de número atómico 74 que se encuentra en el grupo 6 de la tabla periódica de los elementos. Su símbolo es W." },
        ...
        { letter: "w", answer: "weber", status: 0, question: "CONTIENE LA W. Unidad de flujo magnético del sistema internacional, equivalente al flujo magnético que, cuyo símbolo es wb" },
    ],
    [
        ...
        { letter: "x", answer: "xilofono", status: 0, question: "CON LA X. Instrumento músico compuesto de láminas de madera, sostenidas por hilos de seda o cuerda de tripa, de espesor y longitud tales que, golpeados con un martillo dan notas diferentes" },
    ],
    [
...
//FUNCION CONSTRUCTORA DE PLAYER
function Player (){
    this.name = document.getElementById("nombre").value;
    this.score = 0;
  }

//FUNCION DE PRESENTACION DEL JUEGO
function welcome(){
...
//FUNCION PARA OBTENER UN ROSCO DE 27 LETRAS A PARTIR DE LAS DEFINICIONES
function getNewRosco() {

    var rosco = [];
    for (let j=0; j<27; j++) {
        var randNum = Math.floor(Math.random()*5);
        rosco[j] = questions[j][randNum]
    }
    return rosco;
}
...
function inicio() {
    ...
    for (let i = 0; i<rosco.length; i++) {
        document.getElementById(i).className = "letters-nonanswer";
    }
    document.getElementById("boxcontent").style.display = "block";
    document.getElementById("welcome").style.display = "none";
    document.getElementById("inicio").style.display = "none";
    document.getElementById("form-answer").style.display  = "flex";
    document.getElementById("control").style.display = "flex";
    document.getElementById("opselect").style.display = "flex";
    ...
    document.getElementById("question").innerHTML = rosco[0].question;
    document.getElementById(i).className = "letter-selected";

    i = 0;
}

//FUNCION QUE EVALUA LA RESPUESTA INTRODUCIDA POR EL JUGADOR
function answer () {
    ...
    var answer = (document.getElementById("answer").value).toLowerCase();
        switch(answer) {
            case rosco[i].answer:
                rosco[i].status = 1;
                document.getElementById(i).className = "letters-correct";
                player.score +=1;
                document.getElementById("score").innerHTML = player.score;
                break;
            case "pasapalabra":
            ...
            default:
                rosco[i].status = -1;
                document.getElementById(i).className = "letters-wrong";
                break;
        }
...
//FUNCION QUE AVANZA DE LETRA EN EL ROSCO
function mostrarSiguentePregunta() {
    ...
    document.getElementById(i).className = "letter-selected";
    document.getElementById("question").innerHTML = rosco[i].question;
    
}

//FUNCION QUE VERIFICA SI EL ROSCO SE HA COMPLETADO
function verificaRosco() {
...
function endGame() {
    document.getElementById("endButton").innerHTML = `ENHORABUENA ${player.name}!! <br> Has conseguido un total de ${player.score} aciertos! <br> Quieres volver a jugar?` 
    ...
    document.getElementById("opselect").style.display  = "none";
    document.getElementById("time").style.display = "none";
    document.getElementById("score").style.display = "none";
    clearInterval(reloj)
}

//FUNCION PARA AVANZAR UNA LETRA EN EL ROSCO SIN CONTESTARLA
...
document.getElementById("answer").addEventListener('keyup', function (e) {
    if (e.keyCode === 13) {
        ...
        e.preventDefault();
        document.getElementById("pasa").click();
    }
})
