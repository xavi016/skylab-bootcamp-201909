// IMPORTANTE!
// MVC o Modelo-Vista-Controlador es un patrón de arquitectura de software que, utilizando 3 componentes (Vistas, Models y Controladores) separa la lógica de la aplicación de la lógica de la vista en una aplicación.
// Este código se ha desarrollado siguiendo el modelo MVC, pero puesto que los requisitios del ejercicio indican que únicamente se podrá incluir un fichero js, añadiré el código seguido, indicando las separaciones de fichero y un índice a continuación. (Se incluye también otro fichero a parte con el código sin separar).

/** FICHERO 1: MODELO **/ //empieza en el num 10
/** FICHERO 2: VISTA **/ // empieza en el num 113
/** FICHERO 3: CONTROLADOR **/ // empieza en el num 343
//-----------------------------------------------------------------------------
...
//Dom events que dependen de funciones del controlador.
