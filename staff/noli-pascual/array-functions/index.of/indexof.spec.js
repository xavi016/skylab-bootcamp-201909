describe('indexOf', function() {
    ...
    it("Should return index of the first match", function() {
        ...
        expect(indexOf(arr, sear)).toBe(expected);
    ...
    it("Should return -1 if does not find item", function() {
        ...
        expect(indexOf(arr, expression)).toBe(expected);
    ...
    it("Should hrow and error when expresion is not a function", function() {
        var arr = [5, 10, 5, 3];
        var expression = 1;
        expect(function() { indexOf(arr, expression) }).toThrowError('1 is not a function');
