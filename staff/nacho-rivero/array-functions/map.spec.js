describe('map', function() {
    ...
    it('should throw error on non-function expression', function() {
      ...
      expect(function() { map(array, 'gandalf') }).toThrowError(TypeError, 'gandalf is not a function');
      expect(function() { map(array, 123); }).toThrowError(TypeError, '123 is not a function');
