...
describe('logic - register user', () => {
    ...
    let name, surname, email, username, password, modalities
    ...
    it('should succeed on correct credentials', async () => {
        ...
        expect(user.modalities.length).toBeGreaterThan(0)
    })
    ...
    it('should fail on incorrect name, surname, email, password, or expression type and content', () => {
        ...
        expect(() => registerUser(name, surname, email, username, 1)).toThrow(TypeError, '1 is not a string')
        expect(() => registerUser(name, surname, email, username, true)).toThrow(TypeError, 'true is not a string')
        expect(() => registerUser(name, surname, email, username, [])).toThrow(TypeError, ' is not a string')
        expect(() => registerUser(name, surname, email, username, {})).toThrow(TypeError, '[object Object] is not a string')
        expect(() => registerUser(name, surname, email, username, undefined)).toThrow(TypeError, 'undefined is not a string')
        expect(() => registerUser(name, surname, email, username, null)).toThrow(TypeError, 'null is not a string')
        
        expect(() => registerUser(name, surname, email, username, password, 1)).toThrow(TypeError, '1 is not a Array')
        expect(() => registerUser(name, surname, email, username, password, true)).toThrow(TypeError, 'true is not a Array')
        expect(() => registerUser(name, surname, email, username, password, 'hola')).toThrow(TypeError, ' is not a Array')
        expect(() => registerUser(name, surname, email, username, password, {})).toThrow(TypeError, '[object Object] is not a Array')
        expect(() => registerUser(name, surname, email, username, password, undefined)).toThrow(TypeError, 'undefined is not a Array')
        expect(() => registerUser(name, surname, email, username, password, null)).toThrow(TypeError, 'null is not a Array')
    })
